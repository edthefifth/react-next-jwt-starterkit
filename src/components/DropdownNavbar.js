        ...
        return (
            ...
            <Nav className="ml-auto" >
                  <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
                      <DropdownToggle caret color="primary" className="bg-transparent border border-light">
                          <i className='fas fa-user enlarge-font'></i>
                      </DropdownToggle>
                      <DropdownMenu>
                          <h5 className="dropdown-item text-dark text-truncate"><strong>{this.props.alias}</strong></h5>
